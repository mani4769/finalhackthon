...
<body>
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li><button class="btn" role="button"><a href="userpage.php">Home</a></button></li>
            <li><button class="btn" role="button"><a href="about.php">About</a></button></li>
            <li><button class="btn" role="button"><a href="whatis.php">What Is?</a></button></li>
            <li><button class="btn" role="button"><a href="motivation.php">Motivation</a></button></li>
            <li><button class="btn" role="button"><a href="signup.php">Logout</a></button></li>
        </ul>
    </nav>
    <div class="container">
        <div class="content">
            <img src="motivation.jpg" alt="">
            <div class="text">
                <h2>Breaking down stigmas</h2>
                <p>One of the ways the Deaf distinguish themselves as a culture is by capitalizing the word Deaf and working to change mainstream America’s attitude. The Deaf culture doesn’t believe in using the word "disabled" because that word makes implies “less than”—as though they are lacking something. By removing the label, they are also removing any stigma that might be attached.

“It’s about perspective,” Deaf advocate Eileen O’Banion said. “When you are Deaf, you see the world in a different way. You communicate differently. You seek out others who are Deaf because they understand you. You don’t believe you have a disability—and you don’t want to be fixed.”</p>
            </div>
        </div>
</div><br><hr>
<div class="container">
        <div class="content">
            <img src="motivation2.jpg" alt="">
            <div class="text">
                <h2>Tough choices around cochlear implants</h2>
                <p>Meghan Watt lost her hearing after contracting HIB meningitis at the age of two. A conversation with a middle high school teacher piqued her interest in cochlear implant (CI) surgery, even though she admits she wasn’t always keen on the idea. Today, she has bilateral cochlear implants.
...
Some members of the Deaf community are opposed to cochlear implant surgery—especially for infants who are born without hearing. They believe every person deserves the right to choose for themselves whether they want to remain Deaf and encourage parents to begin teaching ASL as the baby’s first language. Some activists believe learning language and cognitive development through ASL is a basic human right that should be protected and that choosing cochlear implants steers families away from learning ASL and embracing Deaf culture.</p>
        ...
        <div class="container">
        <div class="content">
            <img src="motivation3.jpg" alt="">
            <div class="text">
                <h2>Audism and oralism</h2>
                <p>Nine out of 10 Deaf infants are born to hearing parents. Many of those parents choose cochlear implant surgery as soon as they are medically able because it helps their child with speech development.
...
“Deaf culture is important because it allows individuals to be who they are,” O’Banion explained, “and live in a way that is unique to them. There’s more to a person than whether or not they can hear, so don’t just focus on their ears.”</p>
            </div>
        </div>
</div>
    <footer>
